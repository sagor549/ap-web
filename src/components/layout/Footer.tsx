      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-8 grid grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-4 tracking-wide">Our Projects</h3>
              <ul className="space-y-3">
                ...
                <li>
                  <a href="#" className="text-neutral-400 hover:text-white transition-colors block py-1">
                    Web Development
                  </a>
                </li>
                <li>
            ...
            {/* Lab Section */}
            <div>
              <h3 className="text-lg font-semibold mb-4 tracking-wide">Lab</h3>
              <ul className="space-y-3">
                <li>
                  <Link 
                    href="/lab" 
                    onClick={(e) => {
                      ...
                      router.push("/lab", { onTransitionReady: pageTransition });
                    }}
                    className="text-neutral-400 hover:text-white transition-colors block py-1"
                  >
                    Latest Experiments
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="mailto:hello@apagency.com" className="text-neutral-400 hover:text-white transition-colors block py-1">
                    hello@apagency.com
                  </a>
                </li>
                <li>
                  <a href="tel:+11234567890" className="text-neutral-400 hover:text-white transition-colors block py-1">
                    +1 (123) 456-7890
                  </a>
                </li>
                <li>
                ...
                <li className="mt-4">
                  <a 
                    href="/contact" 
                    className="inline-flex items-center text-sm font-medium text-white border border-white px-4 py-2 rounded-full hover:bg-white hover:text-black transition-colors"
                  >
                    Contact Us
